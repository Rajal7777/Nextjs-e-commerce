...
const Search = async (props: {
    ...
    const categoryItems = [
        { name: "All", value: "all" },
        ...categories.map((item) => ({ name: item.category, value: item.category })),
    ];
    ...
    const linkBaseClass = "block rounded-md border px-3 py-2 text-sm transition-colors duration-200";
            ...
            <div className='filter-links md:col-span-1'>
                <aside className="sticky top-20 rounded-xl border bg-card p-4 shadow-sm">
                    ...
                    <div className="space-y-5">
                        <section>
                            <h3 className="mb-2 text-sm font-semibold text-muted-foreground">Search by category</h3>
                        ...
                        <section>
                            <h3 className="mb-2 text-sm font-semibold text-muted-foreground">Search by price</h3>
                            <div className="space-y-2">
                                {priceItems.map((item) => {
                        ...
                        <section>
                            <h3 className="mb-2 text-sm font-semibold text-muted-foreground">Search by customer review</h3>
                            <div className="space-y-2">
